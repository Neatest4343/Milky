...
st.set_page_config(page_title="💌 For Milky", page_icon="❤️", layout="centered")
...
# ------------------ App ------------------
st.markdown("<div class='big'>💖 Hey Milky 😊</div>", unsafe_allow_html=True)
...
if not st.session_state.accepted:
    ...
    st.markdown("### Milky just unlocked Valentine mode 💕")
    ...
    draw.text((170, 140), "Milky’s Valentine", fill="#000000", font=font_small)
