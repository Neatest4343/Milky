...
st.set_page_config(page_title="💌 For Chinwe", page_icon="❤️", layout="centered")
...
# ------------------ App ------------------
st.markdown("<div class='big'>💖 Hey Chinwendu 😊</div>", unsafe_allow_html=True)
...
if not st.session_state.accepted:
    ...
    st.markdown("### Chinwe is  Victor's Val 💕")
    ...
    draw.text((170, 140), "Chinwe's Valentine", fill="#000000", font=font_small)
